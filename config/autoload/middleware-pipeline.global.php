...
use App\Action\BaseUrlMiddleware;
use App\Action\BaseUrlMiddlewareFactory;
...
return [
    ...
    'middleware_pipeline' => [
        ...
        'album_api' => [
            'path' => '/api', // Need to change it below as well when moving the AlbumMiddleware
            'priority' => 5,
            'middleware' => [
                AlbumMiddleware::class,
            ],
        ],
